...
**Pricing posture:** Free tier available; the individual plan is $20/month (Devin 2.0, launched late 2025, a 96% reduction from the original $500), with usage billed on top of the subscription. Team and enterprise tiers sit above it. The team-tier structure and the unit of usage billing have both been restated more than once during 2026 and are deliberately not pinned to a figure here — check the pricing page before budgeting. What has held across every look: the headline $20 is a floor, not the real cost of sustained use.

**Reality check:** Cognition's ARR grew from $1M to $73M in the nine months following the Devin 2.0 price cut, which is a strong adoption signal. Community consensus is consistent: it performs well on well-scoped, specific tasks and struggles on open-ended or multi-system changes requiring deep judgment, with independent benchmark success rates on complex tasks far below the marketing narrative. Task latency is minutes to hours rather than seconds, so it complements rather than replaces in-the-loop tools like Cursor or Claude Code. Noted gotcha: Devin goes quiet on ambiguous tasks, and specifying acceptance criteria upfront dramatically improves results. Budget for ACU consumption rather than the headline price. Comparable to Factory and Augment Code in the autonomous-PR category.
