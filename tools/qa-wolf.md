...
pricing: Platform: free trial, then $0.01/AI credit + $0.15/runner minute (no ongoing free allowance); Coverage as a Service: median ~$90K/year
---
...
**When I wouldn't:**
- Building a solo side project — the managed service is priced for teams; the Platform has no ongoing free allowance after the trial
- When Playwright or Cypress run on CI already covers your needs at no added cost

**Pricing posture:** Platform is free to try, then pay-per-use at $0.01/AI credit and $0.15/runner minute with no ongoing free allowance; the managed Coverage as a Service sits at a median $90K/year annual contract with some engagements over $250K.

**Reality check:** Reviewers consistently praise QA Wolf's execution quality and how quickly they achieve high coverage; the main gotcha is knowledge lock-in — when QA Wolf maintains all tests, internal testing expertise atrophies. Renewal is hard to justify for mid-size teams when renewals are evaluated on cost alone. The self-serve Platform is genuinely self-serve and per-use, with a free trial to evaluate it; after the trial, usage is metered with no ongoing free allowance. Alternatives for solo or small-team use: open Playwright/Cypress on a CI runner, or Mabl and Testim for lighter managed options.
